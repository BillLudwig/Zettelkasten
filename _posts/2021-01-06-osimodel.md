...
The value of the OSI Model is primarily as an abstract mental model that is easy to understand. Real-world networking uses [TCP/IP]({% post_url 2021-01-06-tcpip %}).
