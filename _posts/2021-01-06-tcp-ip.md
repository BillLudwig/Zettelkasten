---
title:  TCP/IP
date:   2021-01-21 21:49:30 -0700
tags: [Networking]
---

The TCP/IP model is similar to the [OSI model]({% post_url 2021-01-06-osi-model %}) but is actually used in real life. Since it is less rigid it is harder to conceptualize which is why the OSI model is still relevant. [Encapsulation]({% post_url 2021-01-19-network-encapsulation %}) works the same in both models.
